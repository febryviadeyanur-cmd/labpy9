...
Tujuan dari praktikum ini adalah untuk memahami dan melatih penggunaan operasi dasar string dalam bahasa pemrograman Python. Melalui praktikum ini dapat mengolah data bertipe teks (string), seperti menghitung jumlah karakter, mengambil karakter tertentu berdasarkan indeks, memodifikasi isi string, serta menampilkan data secara dinamis menggunakan metode format().
